 ...
 * @author stefano
 */
public class FlyingEnemyWalkLeft extends CharacterState{
    
    public FlyingEnemyWalkLeft(){
    ...
    private void setAnimation(){
        ...
        Image stop = SolidObject.loadImage("./src/resources/nemicovolante/fermo/fermoSinistra.png");
        listImage.add(stop);
